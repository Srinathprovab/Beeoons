...
//  Beeoons
//
//  Created by FCI on 03/10/23.
//

import UIKit

class NewSideMenuVC: BaseTableVC {
...
extension NewSideMenuVC:LogoutViewModelDelegate {
...
extension NewSideMenuVC:ProfileUpdateViewModelDelegate {
    func callApi() {
        payload.removeAll()
