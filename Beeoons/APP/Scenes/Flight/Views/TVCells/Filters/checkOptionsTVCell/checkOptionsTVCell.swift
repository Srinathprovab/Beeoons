...
class checkOptionsTVCell: TableViewCell {
    ...
    override func updateUI() {
        ...
        if cellInfo?.key == "menu" {
            ...
            sunImg.image = UIImage(named: cellInfo?.image ?? "")?.withRenderingMode(.alwaysOriginal).withTintColor(.NavBackColor)
    ...
    func setAttributedString() {
        ...
        let atter2 = [NSAttributedString.Key.foregroundColor:UIColor.NavBackColor,NSAttributedString.Key.font:UIFont.OswaldRegular(size: 14)] as [NSAttributedString.Key : Any]
    ...
    func setupUI() {
        ...
        titlelbl.font = UIFont.OswaldRegular(size: 16)
