...
class AcceptTermsAndConditionTVCell: TableViewCell {
    ...
    func setAttributedString(str1:String,str2:String,str3:String,str4:String) {
        ...
        let atter2 = [NSAttributedString.Key.foregroundColor:HexColor("#00A898"),NSAttributedString.Key.font:UIFont.OswaldRegular(size: 14)] as [NSAttributedString.Key : Any]
