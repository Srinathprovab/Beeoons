...
class RoomsCountTVCell: UITableViewCell {
    ...
    func setupUI() {
       ...
       // setuplabels(lbl: addRoomlbl, text: "+ Add Room", textcolor: .WhiteColor, font: .MyriadProRegular(size: 16), align: .center)
       // addRoomBtnView.backgroundColor = .ButtonColor
       // addRoomBtnView.addCornerRadiusWithShadow(color: .clear, borderColor: .clear, cornerRadius: 8)
        ...
        setuplabels(lbl: room1Child1Titlelbl, text: "Child 1", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room1Child2Titlelbl, text: "Child 2", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room1childagevalue1lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room1childagevalue2lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        ...
        setuplabels(lbl: room2Child1Titlelbl, text: "Child 1", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room2Child2Titlelbl, text: "Child 2", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room2childagevalue1lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room2childagevalue2lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        ...
        setuplabels(lbl: room3Child1Titlelbl, text: "Child 1", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room3Child2Titlelbl, text: "Child 2", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room3childagevalue1lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room3childagevalue2lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        ...
        setuplabels(lbl: room4Child1Titlelbl, text: "Child 1", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room4Child2Titlelbl, text: "Child 2", textcolor: .TitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room4childagevalue1lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
        setuplabels(lbl: room4childagevalue2lbl, text: "0", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .center)
    ...
    func setupRoom1ChildageTapDropDown1() {
        ...
        room1ChildageTapDropDown1.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room1childagevalue1lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom1ChildageTapDropDown2() {
        ...
        room1ChildageTapDropDown2.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room1childagevalue2lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom2ChildageTapDropDown1() {
        ...
        room2ChildageTapDropDown1.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room2childagevalue1lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom2ChildageTapDropDown2() {
        ...
        room2ChildageTapDropDown2.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room2childagevalue2lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom3ChildageTapDropDown1() {
        ...
        room3ChildageTapDropDown1.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room3childagevalue1lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom3ChildageTapDropDown2() {
        ...
        room3ChildageTapDropDown2.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room3childagevalue2lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom4ChildageTapDropDown1() {
        ...
        room4ChildageTapDropDown1.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room4childagevalue1lbl.textColor = .TitleColor
        }
    }
    ...
    func setupRoom4ChildageTapDropDown2() {
        ...
        room4ChildageTapDropDown2.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.room4childagevalue2lbl.textColor = .TitleColor
        }
    }
    ...
    func setupUI1() {
        ...
        setuplabels(lbl: titlelbl1, text: "Room 1", textcolor: .SubtitleColor, font: .SigvarRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl1, text: "Adult", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl1, text: "+12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl1, text: "2", textcolor: HexColor("#27272A"), font: .SigvarRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl1, text: "Child", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl1, text: "+2-12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 13), align: .left)
        setuplabels(lbl: childrenCountlbl1, text: "0", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .center)
    ...
    func setupUI2() {
        ...
        setuplabels(lbl: titlelbl2, text: "Room 2", textcolor: .SubtitleColor, font: .SigvarRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl2, text: "Adult", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl2, text: "+12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl2, text: "1", textcolor: HexColor("#27272A"), font: .SigvarRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl2, text: "Child", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl2, text: "+2-12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 13), align: .left)
        setuplabels(lbl: childrenCountlbl2, text: "0", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
    ...
    func setupUI3() {
        ...
        setuplabels(lbl: titlelbl3, text: "Room 3", textcolor: .SubtitleColor, font: .SigvarRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl3, text: "Adult", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl3, text: "+12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl3, text: "1", textcolor: HexColor("#27272A"), font: .SigvarRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl3, text: "Child", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl3, text: "+2-12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 13), align: .left)
        setuplabels(lbl: childrenCountlbl3, text: "0", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
    ...
    func setupUI4() {
        ...
        setuplabels(lbl: titlelbl4, text: "Room 4", textcolor: .SubtitleColor, font: .SigvarRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl4, text: "Adult", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl4, text: "+12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl4, text: "1", textcolor: HexColor("#27272A"), font: .SigvarRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl4, text: "Child", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl4, text: "+2-12 yrs", textcolor: .SubtitleColor, font: .SigvarRegular(size: 13), align: .left)
        setuplabels(lbl: childrenCountlbl4, text: "0", textcolor: .TitleColor, font: .SigvarRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
